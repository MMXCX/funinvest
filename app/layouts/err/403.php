...
<div class="container my-5 py-5 z-depth-1">
    ...
    <section class="px-md-5 mx-md-5 text-center dark-grey-text">
        ...
        <h3 class="font-weight-bold">Доступ запрещен! Авторизируйтесь.</h3>

        <p>Please, let us know how you got here, and use one of the following links to navigate back to safe harbor.</p>

        <a class="btn btn-info btn-sm btn-rounded" href="https://mdbootstrap.com/docs/jquery/" role="button">About
            MDB</a>
        <a class="btn btn-info btn-sm btn-rounded" href="https://mdbootstrap.com/education/bootstrap/" role="button">Tutorial</a>
        <a class="btn btn-info btn-sm btn-rounded" href="https://mdbootstrap.com/products/jquery-ui-kit/" role="button">MDB
            Pro</a>
